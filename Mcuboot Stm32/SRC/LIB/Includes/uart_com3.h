...
//                            \V/ Global DefineS
//#############################################################################
#define UART_COM3_TX_CBUF_SZ          (1024U)
#define UART_COM3_RX_CBUF_SZ          (1024U)
...
//=============================================================================
/*!
* @fn       bool_t UartCom3_Enable (int8_t *vtag_uart3_ptr)
* @brief    This function enables this library.
* @param    *vtag_uart3_ptr (Pass vTag key buffer)
...
*/
//=============================================================================
extern bool_t UartCom3_Enable (int8_t *vtag_uart3_ptr);

//=============================================================================
//                         \V/ UartCom3_Disable
//=============================================================================
/*!
* @fn       bool_t UartCom3_Disable (int8_t *vtag_uart3_ptr)
...
*/
//=============================================================================
extern bool_t UartCom3_Disable (int8_t *vtag_uart3_ptr);

//=============================================================================
//                         \V/ UartCom3_BaseInit
//=============================================================================
/*!
* @fn       void UartCom3_BaseInit (uart_com3_base_t set_uart_com3_base_s)
* @brief    Initialization functions
* @param    set_uart_com3_base_s
* @retval   None
* @warning  if any member of set_uart_com3_base_s is NULL then routine will not
...
*/
//=============================================================================
extern void UartCom3_BaseInit (uart_com3_base_t set_uart_com3_base_s);

//=============================================================================
//                         \V/ UartCom3_TxCbufInit
//=============================================================================
/*!
* @fn       void UartCom3_TxCbufInit (void)
...
//=============================================================================
//                         \V/ UartCom3_RxCbufInit
//=============================================================================
/*!
* @fn       void UartCom3_RxCbufInit (void)
...
//=============================================================================
/*!
* @fn       bool_t UartCom3_TxData(void *ip_data_ptr, uint16_t data_sz)
...
* @warning  UartCom3_HalTxFptr must be initialized first.
* @note     None
* @author   MK
* @date     21-APR-2021
* @remark   Designed & Developed by VOIDRON CO.
...
//=============================================================================
//                         \V/ UartCom3_TxIsrPrcs
//=============================================================================
/*!
* @fn       void UartCom3_TxIsrPrcs (void)
...
*/
//=============================================================================
extern void UartCom3_TxIsrPrcs (void);

//=============================================================================
//                         \V/ UartCom3_RxData
//=============================================================================
/*!
* @fn       bool_t UartCom3_RxData(void *op_data_ptr, uint16_t data_sz)
* @brief    Function to receive stream of data
* @param    op_data_ptr: Output data pointer
* @param    data_sz: Output data size in bytes
* @retval   cbuf_full_err_f: True if full
* @warning  UartCom3_HalRxFptr must be initialized first.
* @note     None
* @author   MK
* @date     24-JAN-2021
* @remark   Designed & Developed by VOIDRON CO.
...
//=============================================================================
//                         \V/ UartCom3_GetRxDataSz
//=============================================================================
/*!
* @fn       uint16_t UartCom3_GetRxDataSz(void)
...
//=============================================================================
//                         \V/ UartCom3_RxIsrPrcs
//=============================================================================
/*!
* @fn       void UartCom3_RxIsrPrcs (void)
...
*/
//=============================================================================
extern void UartCom3_RxIsrPrcs (void);

//=============================================================================
//                         \V/ UartCom3_GetRxOvfFlag
//=============================================================================
/*!
* @fn       bool_t UartCom3_GetRxOvfFlag (void)
* @brief    Read RX buffer over flow flag
* @param    None
* @retval   uart3_rx_ovf_f: True if Rx buffer Overflow
* @warning  None
* @note     Buffer size can be adjusted by UART_COM3_RX_CBUF_SZ
* @author   MK
* @date     24-JAN-2021
* @remark   Designed & Developed by VOIDRON CO.
*/
...
//=============================================================================
//                         \V/ UartCom3_GetTxOverFlag
//=============================================================================
/*!
* @fn       bool_t UartCom3_GetTxOverFlag (void)
* @brief    Read Transmit completed flag
* @param    None
* @retval   uart3_tx_over_f: True if Tx over
* @warning  None
* @note     Buffer size can be adjusted by UART_COM3_TX_CBUF_SZ
* @author   MK
* @date     24-JAN-2021
* @remark   Designed & Developed by VOIDRON CO.
*/
...
//=============================================================================
//                         \V/ UartCom3_TickIsrPrcs
//=============================================================================
/*!
* @fn       void UartCom3_TickIsrPrcs (void)
...
//=============================================================================
//                         \V/ UartCom3_GetRxFlag
//=============================================================================
/*!
* @fn       bool_t UartCom3_GetRxFlag (void)
* @brief    Get flag after receiving data
* @param    None
* @retval   com_uart3_timeout_f
* @warning  None
* @note     None
* @author   MK
* @date     24-JAN-2021
...
//=============================================================================
//                         \V/ UartCom3_ClrRxFlag
//=============================================================================
/*!
* @fn       void UartCom3_ClrRxFlag (void)
