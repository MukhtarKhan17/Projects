...
#ifndef HAL_USART1_STM32F103RX_H_
#define HAL_USART1_STM32F103RX_H_
...
#define USART1_PORT_CLK_EN           (RCC_APB2Periph_GPIOA)

#define USART1_PORT_TX_DEF        	 (GPIOA)
#define USART1_PORT_RX_DEF        	 (GPIOA)
#define USART1_PIN_TX_DEF        	 (GPIO_Pin_9)
#define USART1_PIN_RX_DEF        	 (GPIO_Pin_10)
...
*==============================================================================
*/
typedef void (*Uart1TxIsrFptrT)(void);
typedef void (*Uart1RxIsrFptrT)(void);
/**
*==============================================================================
*                            \V/ Global VariableS
*==============================================================================
...
*==============================================================================
*/
extern void Usart1_Init (Uart1TxIsrFptrT SetTxIsrFptr,
						 Uart1RxIsrFptrT SetRxIsrFptr);
extern void Usart1_TxData (uint8_t tx_data);
extern uint8_t Usart1_RxData (void);
...
#endif // >> End of HAL_USART1_STM32F103RX_H_
